...
let niceBook1: Book = Book (title: "Where the Red Fern Grows", author: wilsonRawls, pages: 245, numberOfStars: 4, description: "nice clean book", genre: "children")
let niceBook2: Book = Book (title: "The Hobbit", author: johnTolkien, pages: 300, numberOfStars: 4.5, description: "nice clean funny cute book", genre: "fantasy")
let niceBook3: Book = Book (title: "Frankenstein", author: maryShelley, pages: 280, numberOfStars: 4.7, description: "nice clean comic and hilarious book attempting to be scary", genre: "gothic")
